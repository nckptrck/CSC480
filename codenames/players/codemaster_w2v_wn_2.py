...
class AICodemaster(Codemaster):
    ...
    def get_clue(self):
        ...
        for word in self.cm_wordlist:
            ...
            if (self.get_wn_similarity(word, [rw], bad_words)[1] > 0.5 or
                self.get_w2v_similarity(word, [rw], bad_words)[1] > 0.5)
        ]
        ...
        # if the two algorithms has multiple red words above similaryity, return 1. otherwise return 1
